...
<aside class=" w-1/5 py-10 px-10  min-w-min  border-l border-gray-300 dark:border-zinc-700 hidden lg:block ">
    ...
    <div class="relative items-center content-center flex">
        ...
        <form action="{{ route('dashboard') }}" method="GET" class="relative items-center content-center flex w-full">
            <span class="text-gray-400 absolute left-4 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="mt-10 flex flex-col gap-y-4 text-gray-500 fill-gray-500 text-sm">
        <div
            class="flex items-center space-x-2 py-1 text-gray-400/70 font-medium uppercase group hover:border-r-4 hover:border-r-red-600 hover:font-semibold dark:hover:text-white">
            <svg class="h-5 w-5 group-hover:stroke-red-600" xmlns="http://www.w3.org/2000/svg" fill="none"
