...
<aside class=" w-1/5 py-10 px-10  min-w-min  border-l border-gray-300 dark:border-zinc-700 hidden lg:block ">
    ...
    <div class="mt-10 flex flex-col gap-y-4 text-gray-500 fill-gray-500 text-sm">
        <div class="flex items-center space-x-2 py-1 text-gray-400/70 font-medium uppercase group hover:border-r-4 hover:border-r-red-600 hover:font-semibold dark:hover:text-white">
            <svg class="h-5 w-5 group-hover:stroke-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
