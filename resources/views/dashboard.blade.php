    ...
    <main class=" flex-1 py-10  px-5 sm:px-10 ">
        ...
        <section>
            <nav class="flex space-x-6 text-gray-400 font-medium">
                <a href="{{ route('dashboard') }}" class="{{ request('type') == null ? 'text-gray-700 dark:text-white font-semibold' : 'hover:text-gray-700 dark:hover:text-white' }}">
                    All
                </a>
        ...
        <div class="mt-10 flex justify-center">
            ...
            <div class="flex items-center space-x-2 fill-gray-500">
                ...
                @else
                <a href="{{ $movies->previousPageUrl() }}" class="h-7 w-7 rounded-full border p-1 hover:border-red-600 hover:fill-red-600 dark:fill-white dark:hover:fill-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 24 24">
                        <path d="M13.293 6.293L7.58 12l5.7 5.7 1.41-1.42 -4.3-4.3 4.29-4.293Z"></path>
                    </svg>
                </a>
                ...
                <a href="{{ $movies->nextPageUrl() }}" class="h-7 w-7 rounded-full border p-1 hover:border-red-600 hover:fill-red-600 dark:fill-white dark:hover:fill-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 24 24">
