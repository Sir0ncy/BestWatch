                            ...
                            <div class="absolute top-0.5 right-0.5 z-10">
                                ...
                                @else
                                    <form action="{{ route('my-list.add', $movie->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" title="Tambah ke Favorit" class="flex items-center justify-center p-0.7 bg-white rounded-full text-gray-400 hover:text-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 border border-gray-400 hover:border-black">
